...
public class ThreadPoolConfig {
    ...
    @Bean(name = "asyncAnalysisExecutor", destroyMethod = "shutdown")
    public ExecutorService asyncAnalysisExecutor() {
        return Executors.newFixedThreadPool(2, namedThreadFactory("analysis-async"));
    }
